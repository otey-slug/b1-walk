...
It renames all the occurrences of b1_walk_oliver (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the b1_walk_oliver folder
        os.rename(
            os.path.join(root_dir_path, "exts", "b1_walk_oliver", "b1_walk_oliver"),
            os.path.join(root_dir_path, "exts", "b1_walk_oliver", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "b1_walk_oliver"), os.path.join(root_dir_path, "exts", new_name))
