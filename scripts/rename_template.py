...
It renames all the occurrences of b1-walk (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the b1-walk folder
        os.rename(
            os.path.join(root_dir_path, "exts", "b1-walk", "b1-walk"),
            os.path.join(root_dir_path, "exts", "b1-walk", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "b1-walk"), os.path.join(root_dir_path, "exts", new_name))
