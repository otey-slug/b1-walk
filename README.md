...
- Throughout the repository, the name `b1_walk` only serves as an example and we provide a script to rename all the references to it automatically:

```
# Rename all occurrences of b1_walk (in files/directories) to your_fancy_extension_name
